...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cards__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common__ = __webpack_require__(69);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_tabs_component__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_js_modal__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_socket_io__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_App__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__store_index__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__routes_router__ = __webpack_require__(58);





__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_tabs_component___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_js_modal___default.a, { dynamic: true, injectModalsContainer: true });





__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(new __WEBPACK_IMPORTED_MODULE_3_vue_socket_io___default.a({
    debug: true,
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    router: __WEBPACK_IMPORTED_MODULE_6__routes_router__["a" /* router */]
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    name: "App",
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapGetters */])(['isUserLoggedIn']))
});
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      "div",
      { staticClass: "container bg-white py-4" },
      [_c("router-view")],
      1
    )
  ])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__state__ = __webpack_require__(54);
...
var getters = {
    ...
    //     }, 0);
    // },
    messageList: function messageList(state) {
...
var mutations = {
    ADD_NEW_MESSAGE: function ADD_NEW_MESSAGE(state, data) {
        state.messages.push(data);
    },
    SIGN_IN: function SIGN_IN(state, data) {

        // state.messages.push(data);
    },
    SET_AUTH_ERRORS: function SET_AUTH_ERRORS(state, data) {
        state.authErrors = data;
    },
    CLEAR_AUTH_ERRORS: function CLEAR_AUTH_ERRORS(state, data) {
        state.authErrors = {};
    },
...
var actions = {
    addNewMessage: function addNewMessage(context, params) {
        context.commit('ADD_NEW_MESSAGE', params);
    },
    signIn: function signIn(context, params) {
        axios.post('/sign-in', params).then(function (response) {
            console.log('respo');
    ...
    signUp: function signUp(context, params) {
        axios.post('/sign-up', params).then(function (response) {
            if (response.status === 201 || response.status === 200) context.commit('SET_AUTH_USER', response.data);

            context.commit('CLEAR_AUTH_ERRORS');
        }).catch(function (error) {
            if (error.response) context.commit('SET_AUTH_ERRORS', error.response.data.errors);
            console.error(error);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Users__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Users___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_Users__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cards_Cards__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cards_Cards___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_cards_Cards__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Cases__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Cases___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_Cases__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Case__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Case___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_Case__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_EmailForm__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_EmailForm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_EmailForm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Chat__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Chat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__components_Chat__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_auth_Login__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_auth_Login___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8__components_auth_Login__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_auth_Register__ = __webpack_require__(107);
...
var router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
    ...
    routes: [{
        path: '/sign-in',
        name: 'sign-in',
        component: __WEBPACK_IMPORTED_MODULE_8__components_auth_Login___default.a
    }, {
        path: '/sign-up',
        name: 'sign-up',
        ...
        path: '/users',
        name: 'users',
        component: __WEBPACK_IMPORTED_MODULE_2__components_Users___default.a
    }, {
        path: '/cases',
        name: 'cases',
        component: __WEBPACK_IMPORTED_MODULE_4__components_Cases___default.a
    }, {
        path: '/cases/:caseId',
        name: 'case',
        component: __WEBPACK_IMPORTED_MODULE_5__components_Case___default.a
    }, {
        path: '/',
        name: 'cards',
        component: __WEBPACK_IMPORTED_MODULE_3__components_cards_Cards___default.a
    }, {
        path: '/email',
        name: 'email',
        component: __WEBPACK_IMPORTED_MODULE_6__components_EmailForm___default.a
    }, {
        path: '/chat',
        name: 'chat',
        component: __WEBPACK_IMPORTED_MODULE_7__components_Chat___default.a
    }]
});

router.beforeEach(function (to, from, next) {
    // redirect to login page if not logged in and trying to access a restricted page
    var publicPages = ['/sign-in', '/sign-up'];
    var authRequired = !publicPages.includes(to.path);
    var loggedIn = localStorage.getItem('authUser');
...
/* scopeId */
var __vue_scopeId__ = "data-v-30c27aa6"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
var update = __webpack_require__(3)("ffd0ab1c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-30c27aa6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Users.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-30c27aa6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Users.vue");
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-093beb30"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-093beb30", Component.options)
  } else {
    hotAPI.reload("data-v-093beb30", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7f1c4301", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-093beb30\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Cases.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-093beb30\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Cases.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_laravel_vue_pagination__ = __webpack_require__(75);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        Pagination: __WEBPACK_IMPORTED_MODULE_0_laravel_vue_pagination___default.a
    },
    methods: {
        getCases: function getCases() {
            ...
            axios.get('/storage/cases', { params: params }).then(function (response) {
                if (response.status === 200) {
                    console.log(response);
                    _this.cases = response.data.cases;
                }
            }).catch(function (error) {
  ...
  return _c(
    ...
    [
      _c("div", { staticClass: "row" }, [
        _vm._m(0),
        _vm._v(" "),
        _c("div", { staticClass: "col-lg-9 col-md-8 col-sm-6" }, [
          _c("div", { staticClass: "row" }, [
            _c(
              "div",
              { staticClass: "col-lg-4 offset-lg-8 col-md-6 offset-md-6" },
              [
                _c("input", {
                  directives: [
                    {
      ...
      _vm._v(" "),
      _c("table", { staticClass: "table table-bordered my-2" }, [
        _c(
          "tbody",
          _vm._l(_vm.cases.data, function(caseData) {
            return _c("tr", { key: caseData.id }, [
              _c(
                "td",
                [
                  _c(
                    "router-link",
                    {
                      staticClass: "card-link",
                      attrs: {
                        to: { name: "case", params: { caseId: caseData.id } }
                      }
                    },
                    [
                      _vm._v(
                        "\n                    " +
                          _vm._s(caseData.title) +
                          "\n                "
                      )
                    ]
                  )
      ...
      _c("pagination", {
        ...
        attrs: { data: _vm.cases, "show-disabled": true, limit: 5 },
        on: { "pagination-change-page": _vm.getCases }
      })
    ],
    1
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-093beb30", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-b6364bca"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/Case.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b6364bca", Component.options)
  } else {
    hotAPI.reload("data-v-b6364bca", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("c58129d0", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b6364bca\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Case.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b6364bca\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Case.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cards_CardsTableItem__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_DeleteConfirmationModal__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_DeleteConfirmationModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__common_DeleteConfirmationModal__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        beforeSave: function beforeSave() {
            if (!this.caseData.user_id) this.caseData.user_id = null;
        },
        deleteCard: function deleteCard(index) {
            var _this3 = this;

            axios.delete('/storage/cards/' + this.cards[index].id).then(function (response) {
        ...
        deleteCase: function deleteCase() {
            ...
            axios.delete('/storage/cases/' + this.caseData.id).then(function (response) {
                _this4.$router.push({ name: 'cards', params: { userId: '123' } });
            }).catch(function (error) {
                return console.error(error);
            });
        },
        showDeleteModal: function showDeleteModal(index) {
            var questionText = index !== null ? 'Are you sure you want to delete card ' + this.cards[index].name + '?' : 'Are you sure you want to delete case ' + this.caseData.title + '?';
            var data = { text: questionText };
            if (index) data.index = index;

            this.$modal.show(__WEBPACK_IMPORTED_MODULE_2__common_DeleteConfirmationModal___default.a, data, { height: '180px', pivotY: 0.1, draggable: true });
        },
        hideDeleteModal: function hideDeleteModal(data) {
            var response = data.response;
            var index = data.index;
            if (response === 'yes') {
                if (index) this.deleteCard(index);else this.deleteCase();
            }
        }
    },
    created: function created() {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("69760b84", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_index__ = __webpack_require__(9);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            cardTypes: [__WEBPACK_IMPORTED_MODULE_0__constants_index__["a" /* cardConstants */].TYPE_CREDIT, __WEBPACK_IMPORTED_MODULE_0__constants_index__["a" /* cardConstants */].TYPE_DEBIT],
      ...
      _c("div", { staticClass: "form-group mb-0" }, [
        this.mode === this.commonConstants.GENERAL_MODE
          ...
          : _c("input", {
              ...
              staticClass: "form-control",
              class: {
                "is-invalid": _vm.errors["cards." + _vm.index + ".name"]
              },
              attrs: { type: "text" },
        ...
        _c("strong", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.errors["cards." + _vm.index + ".name"]
                ? this.errors["cards." + _vm.index + ".name"][0]
                : ""
            )
          )
        ])
      ...
      _c("div", { staticClass: "form-group mb-0" }, [
        this.mode === this.commonConstants.GENERAL_MODE
          ...
          : _c("input", {
              ...
              staticClass: "form-control",
              class: {
                "is-invalid": _vm.errors["cards." + _vm.index + ".last_number"]
              },
              attrs: { type: "text" },
        ...
        _c("strong", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.errors["cards." + _vm.index + ".last_number"]
                ? _vm.errors["cards." + _vm.index + ".last_number"][0]
                : ""
            )
          )
        ])
      ...
      _c("div", { staticClass: "form-group mb-0" }, [
        this.mode === this.commonConstants.GENERAL_MODE
          ...
          : _c("input", {
              ...
              staticClass: "form-control",
              class: {
                "is-invalid": _vm.errors["cards." + _vm.index + ".total_value"]
              },
              attrs: { type: "number" },
        ...
        _c("strong", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.errors["cards." + _vm.index + ".total_value"]
                ? _vm.errors["cards." + _vm.index + ".total_value"][0]
                : ""
            )
          )
        ])
    ...
    _c("td", [
      _c("div", { staticClass: "form-group mb-0" }, [
        this.mode === this.commonConstants.GENERAL_MODE
          ...
          : _c(
              "select",
              {
                ...
                staticClass: "form-control",
                class: {
                  "is-invalid": _vm.errors["cards." + _vm.index + ".card_type"]
                },
                on: {
        ...
        _c("strong", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.errors["cards." + _vm.index + ".card_type"]
                ? _vm.errors["cards." + _vm.index + ".card_type"][0]
                : ""
            )
          )
        ])
      ...
      _c("div", { staticClass: "form-group mb-0" }, [
        this.mode === this.commonConstants.GENERAL_MODE
          ...
          : _c("input", {
              ...
              staticClass: "form-control",
              class: {
                "is-invalid": _vm.errors["cards." + _vm.index + ".close_date"]
              },
              attrs: { type: "date" },
        ...
        _c("strong", { staticClass: "invalid-feedback" }, [
          _vm._v(
            _vm._s(
              _vm.errors["cards." + _vm.index + ".close_date"]
                ? _vm.errors["cards." + _vm.index + ".close_date"][0]
                : ""
            )
          )
        ])
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-689e0554"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/components/common/DeleteConfirmationModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-689e0554", Component.options)
  } else {
    hotAPI.reload("data-v-689e0554", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("7085a9b2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-689e0554\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DeleteConfirmationModal.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-689e0554\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DeleteConfirmationModal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
      ...
      _c("div", { staticClass: "text-center mt-4" }, [
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                _vm.$emit("close", { response: "yes", index: _vm.index })
              }
            }
          },
          [_vm._v("Yes")]
        ...
        _c(
          "button",
          {
            ...
            on: {
              click: function($event) {
                _vm.$emit("close", { response: "no", index: _vm.index })
              }
            }
          },
          [_vm._v("No")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-689e0554", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        ...
        [
          ...
          this.mode === this.commonConstants.GENERAL_MODE
            ? [
                _c("span", {
                  staticClass: "btn fa fa-trash float-right mx-2",
                  on: {
                    click: function($event) {
                ...
                _vm._v(" "),
                _c("span", {
                  staticClass: "btn fa fa-edit float-right mx-2",
                ...
                _c("td", [
                  _c("div", { staticClass: "form-group mb-0" }, [
                    ...
                    _c("strong", { staticClass: "invalid-feedback" }, [
                      _vm._v(
                        _vm._s(
                          this.errors.website ? this.errors.website[0] : ""
                        )
                      )
                    ])
                  ])
                ...
                _c("td", [
                  _c("div", { staticClass: "form-group mb-0" }, [
                    ...
                    _c("strong", { staticClass: "invalid-feedback" }, [
                      _vm._v(
                        _vm._s(
                          this.errors.country ? this.errors.country[0] : ""
                        )
                      )
                    ])
                  ])
                ...
                _c("td", [
                  _c("div", { staticClass: "form-group mb-0" }, [
                    ...
                    _c("strong", { staticClass: "invalid-feedback" }, [
                      _vm._v(
                        _vm._s(
                          this.errors.user_id ? this.errors.user_id[0] : ""
                        )
                      )
                    ])
                  ])
      ...
      _vm._v(" "),
      _c("modals-container", { on: { close: _vm.hideDeleteModal } })
    ],
    1
  )
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5067eeb6"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5067eeb6", Component.options)
  } else {
    hotAPI.reload("data-v-5067eeb6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("a7f29306", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5067eeb6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EmailForm.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5067eeb6\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EmailForm.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        send: function send() {
            ...
            axios.post('/email/send', this.formData).then(function (response) {
                if (response.status === 200) {
                    _this.status = 'send';
                }
            }).catch(function (error) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-lg-8 offset-lg-2 col-md-8 offset-md-3 " }, [
      _c("div", { staticClass: "form-group" }, [
        _c("label", { attrs: { for: "name" } }, [_vm._v("Enter Your Name")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("label", { attrs: { for: "name" } }, [_vm._v("Enter Your Email")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
      ...
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("label", { attrs: { for: "name" } }, [_vm._v("Enter Your Message")]),
        _vm._v(" "),
        _c("textarea", {
          directives: [
            {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5067eeb6", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0d66c37a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("ba221ae6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapGetters */])(['messageList'])),
    sockets: {
    ...
    _c("div", { staticClass: "col-lg-8 offset-lg-2" }, [
      _c(
        "div",
        {
          staticClass: "alert",
          class: {
            "alert-success": _vm.isConnected,
            "alert-danger": !_vm.isConnected
          }
        },
        [
          _c("strong", [
        ...
        _c("div", { staticClass: "container my-4" }, [
          ...
          _c(
            ...
            _vm._l(_vm.messageList, function(item) {
              return _c(
                "div",
                { key: item.date, staticClass: "message-container text-right" },
                [
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("456a70de", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapGetters */])(['authErrors'])),
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])(['signIn']), {
...
var render = function() {
  ...
  return _c("div", { staticClass: "auth-container" }, [
    _c("div", { staticClass: "login-wrap" }, [
      _c("span", { staticClass: "title" }, [_vm._v("Sign In")]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("input", {
          directives: [
          ...
          staticClass: "input-large form-control",
          class: { "is-invalid": _vm.authErrors.email },
        ...
        _vm._v(" "),
        _c("strong", { staticClass: "invalid-feedback px-20" }, [
          _vm._v(_vm._s(_vm.authErrors.email ? _vm.authErrors.email[0] : ""))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("input", {
          ...
          staticClass: "input-large form-control",
          class: { "is-invalid": _vm.authErrors.password },
        ...
        _c("strong", { staticClass: "invalid-feedback px-20" }, [
          _vm._v(
            _vm._s(_vm.authErrors.password ? _vm.authErrors.password[0] : "")
          )
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "text-center bold mt-5" }, [
        _c(
          "div",
          {
            staticClass: "round-btn round-large-btn blue",
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "nav-link", attrs: { to: { name: "sign-up" } } },
            [_vm._v("Sign Up")]
          )
        ],
        1
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("a5b25210", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapGetters */])(['authErrors'])),
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapActions */])(['signUp']), {
        handleSubmit: function handleSubmit(e) {
            var name = this.name,
                email = this.email,
                password = this.password,
            ...
            this.signUp({ name: name, email: email, password: password, password_confirmation: confirmPassword });
        }
    })
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "auth-container" }, [
    _c("div", { staticClass: "login-wrap" }, [
      _c("span", { staticClass: "title" }, [_vm._v("Sign Up")]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
        _c("input", {
          directives: [
          ...
          staticClass: "input-large form-control",
          class: { "is-invalid": _vm.authErrors.name },
        ...
        _vm._v(" "),
        _c("strong", { staticClass: "invalid-feedback px-20" }, [
          _vm._v(_vm._s(_vm.authErrors.name ? _vm.authErrors.name[0] : ""))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "form-group" }, [
      ...
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "nav-link", attrs: { to: { name: "sign-in" } } },
            [_vm._v("Sign In")]
          )
        ],
        1
